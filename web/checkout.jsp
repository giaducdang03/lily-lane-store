                                                    ...
                                                    <c:forEach var="entry" items="${sessionScope.CHECKOUT.cart}">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <c:forEach var="proErr" items="${requestScope.PRODUCT_ERROR}">
                                                                        <c:if test="${entry.value.ID == proErr.ID}">
                                                                            <span class="mess-error">Sorry! Currently, only ${proErr.quantity} products left</span>
                                                                        </c:if>
                                                                    </c:forEach>
                                                                </td>
                                                                <td class="quantity">
                                                                    <input type="number" value="${entry.value.quantity}" min="1" readonly>
                                                                </td>
                            ...
                            <div class="checkout">
                                <div>
                                    ...
                                    <table class="table-cart">
                                        <tr>
                                            <td>Full Name:</td>
                                            <td class="in4"><input type="text" value="${sessionScope.LOGIN_USER.fullName}" readonly></td>
                                        </tr>
                                        <tr>
                                            <td>Address:</td>
                                            <td class="in4">
                                                <c:if test="${empty sessionScope.LOGIN_USER.address}">
                                                    <input type="text" name="address" value="${sessionScope.LOGIN_USER.address}" required=""/>
                                                </c:if>
                                                <c:if test="${not empty sessionScope.LOGIN_USER.address}">
                                                    <input type="text" name="address" value="${sessionScope.LOGIN_USER.address}" required="" readonly=""/>
                                                </c:if>
                                            </td>
                                        </tr>
                                        <tr class="in4">
                                            <td>Email:</td>
                                            <td><input type="text" value="${sessionScope.LOGIN_USER.email}" readonly=""></td>
                                        </tr>
