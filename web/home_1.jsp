                                    ...
                                    <form action="MainController">
                                        <div class="best-add-to-cart">
                                            <div class="cart-service">
                                                ...
                                                <input type="submit" id="action" name="action" value="ADD TO CART"/>
    ...
    <script>
        $(document).ready(function () {
            $("#submitBtn").click(function () {
                ...
                $.ajax({
                    type: "GET",
                    url: "MainController?action=" + action + "&productID=" + productID,
                    dataType: "json",
                    success: function (response) {
                        // Kiểm tra trạng thái thành công từ phản hồi JSON
                        if (response.status === "success") {
                            var message = response.message;
                            // Xử lý thông báo thành công ở đây
                            alert("Success: " + message);
                        } else {
                            // Xử lý trạng thái lỗi từ phản hồi JSON
